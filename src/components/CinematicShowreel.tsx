...
interface CinematicShowreelProps {
  content?: AboutPhilosophyData["showreel"];
}

export default function CinematicShowreel({
  content = ABOUT_PHILOSOPHY_FALLBACK.showreel,
}: CinematicShowreelProps) {
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center">
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 pointer-events-none">
                ...
                <h3 className="font-serif text-3xl text-white">{content.captionTitle}</h3>
              </div>
            </motion.div>
          </div>
        )}
