            ...
            {!isSubmitted ? (
              <>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-sans text-[10px] tracking-[0.2em] uppercase text-[#b7955b]">Exclusive Asset</span>
                </div>
                
                <h4 className="font-serif text-xl text-white mb-2 leading-tight">
                  The 2026 Guide to Sustainable Brutalism.
                </h4>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
                  ...
                  >
                    {isSubmitting ? "Unlocking..." : "Unlock Guide"}
              ...
              >
                ...
                <h4 className="font-serif text-lg text-white mb-2">Check your inbox.</h4>
                <p className="font-sans text-xs text-white/60">The exclusive guide has been sent to your email.</p>
              </motion.div>
            )}
          </motion.div>
        ) : (
          ...
          <div className="relative flex flex-col items-center">
            <AnimatePresence>
              {isMenuOpen && (
                ...
                >
                  <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-center hover:bg-[#b7955b]/20 hover:border-[#b7955b]/50 transition-all group shadow-xl relative" title="WhatsApp">
                    <MessageCircle size={18} className="text-white/70 group-hover:text-[#b7955b] transition-colors" />
                  </a>
                  <a href="mailto:hello@vaastu-studio.com" className="w-12 h-12 bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-center hover:bg-[#b7955b]/20 hover:border-[#b7955b]/50 transition-all group shadow-xl relative" title="Email Us">
