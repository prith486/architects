            ...
            {!isSubmitted ? (
              <div className="relative z-10 w-full">
                ...
                <h2 className="font-serif text-4xl md:text-5xl text-white mb-4 leading-tight">
                  Access the <br className="hidden md:block"/> Private Client Vault.
                </h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-sm mx-auto flex flex-col gap-4">
                  ...
                  >
                    {isSubmitting ? "Unlocking..." : "Grant Access"}
              ...
              >
                ...
                <h3 className="font-serif text-3xl text-white mb-3">Access Granted.</h3>
