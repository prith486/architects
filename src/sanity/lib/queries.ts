...
export const contactFooterQuery = `
  *[_type == "contactFooter"][0] {
    ...
    contactStudioLabel,
    contactInquiriesLabel,
    contactRequestInfoLabel,
    contactBookConsultLabel,
    contactNameLabel,
    contactEmailLabel,
    contactNameValidationMessage,
    contactEmailValidationMessage,
    contactSubmitText,
    contactSubmittingText,
    contactSuccessHeading,
    contactSuccessDescription,
    contactCalendlyHeading,
    contactCalendlyDescription,
    leadMagnetEyebrow,
    leadMagnetHeading,
    leadMagnetDescription,
    leadMagnetEmailPlaceholder,
    leadMagnetValidationMessage,
    leadMagnetSubmitText,
    leadMagnetSubmittingText,
    leadMagnetSuccessHeading,
    leadMagnetSuccessDescription,
    leadMagnetWhatsappUrl,
    exitIntentEyebrow,
    exitIntentHeading,
    exitIntentDescription,
    exitIntentEmailPlaceholder,
    exitIntentValidationMessage,
    exitIntentSubmitText,
    exitIntentSubmittingText,
    exitIntentCloseText,
    exitIntentSuccessHeading,
...
export const aboutPhilosophyQuery = `
  *[_type == "aboutPhilosophy"][0] {
    ...
    showreelTitle,
    showreelVideoUrl,
    showreelCaptionEyebrow,
    showreelCaptionTitle
  }
`
...
export const homepageQuery = `
  *[_type == "homepage"][0] {
    ...
    pedigreeEyebrow,
    pedigreeItems,
    visionBuilderEyebrow,
    visionBuilderHeading,
    visionBuilderSteps[] {
      title,
      options[] {
        id,
    ...
    visionBuilderCaptureHeading,
    visionBuilderCaptureDescription,
    visionBuilderEmailPlaceholder,
    visionBuilderValidationMessage,
    visionBuilderSubmitText,
    visionBuilderSubmittingText,
    visionBuilderSuccessHeading,
    visionBuilderSuccessDescription,
    seo {
      title,
      description,
      image {
